...
import 'package:the_new_pitchapp/CompanyBottomNavigation/Home/bookmark_tab.dart';
...
class ComapnyBookmarkPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return CompanyBookmarkBody();
  }
}

class CompanyBookmarkBody extends StatefulWidget {
  @override
  _ComapnyBookmarkBodyState createState() => _ComapnyBookmarkBodyState();
}

class _ComapnyBookmarkBodyState extends State<CompanyBookmarkBody> {
  @override
  Widget build(BuildContext context) {
    List<Tab> tabs = [
    ...
    return CompanyBookMarkTabPage(videos1, imagesInDisc1, false);
