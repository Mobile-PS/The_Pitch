...
class CompanyBookMarkTabPage extends StatelessWidget {
  ...
  CompanyBookMarkTabPage(this.videos, this.images, this.isFollowing,
      {this.variable});

  @override
  Widget build(BuildContext context) {
    return ComapnyBookmarkTabBody(videos, images, isFollowing, variable);
  }
}

class ComapnyBookmarkTabBody extends StatefulWidget {
  final List<String> videos;
  final List<String> images;
  ...
  ComapnyBookmarkTabBody(
      this.videos, this.images, this.isFollowing, this.variable);

  @override
  _CompanyBookmarkTabBodyState createState() => _CompanyBookmarkTabBodyState();
}

class _CompanyBookmarkTabBodyState extends State<ComapnyBookmarkTabBody> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          /*PositionedDirectional(end: 20, top: 34, child:
