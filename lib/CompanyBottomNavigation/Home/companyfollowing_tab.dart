...
class CompanyFollowingTabPage extends StatelessWidget {
  final List<EData> videos;
  final bool isFollowing;

  final int? variable;


  CompanyFollowingTabPage(this.videos, this.isFollowing,
      {this.variable});

  @override
  Widget build(BuildContext context) {
    return CompanyFollowingTabBody(videos, isFollowing, variable);
  }
}

class CompanyFollowingTabBody extends StatefulWidget {
  final List<EData> videos;

  final bool isFollowing;
  final int? variable;

  CompanyFollowingTabBody(
      this.videos, this.isFollowing, this.variable);

  @override
  _CompanyFollowingTabBodyState createState() =>
      _CompanyFollowingTabBodyState();
}

class _CompanyFollowingTabBodyState extends State<CompanyFollowingTabBody> {
    ...
    return PageView.builder(
      ...
      itemBuilder: (context, position) {
        return VideoPage(
          ...
          widget.videos[position].companyLogo!,
          widget.videos[position].companyName!,
          pageIndex: position,
...
class _VideoPageState extends State<VideoPage> with RouteAware {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.network(widget.video,formatHint: VideoFormat.other)
