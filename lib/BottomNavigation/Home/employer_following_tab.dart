...
class EmployerFollowingTabPage extends StatelessWidget {
  final List<EData> videos;
  final bool isFollowing;

  final int? variable;

  EmployerFollowingTabPage(this.videos, this.isFollowing,
      {this.variable});

  @override
  Widget build(BuildContext context) {
    return EmpFollowingTabBody(videos, isFollowing, variable);
  }
}

class EmpFollowingTabBody extends StatefulWidget {
  final List<EData> videos;
  ...
  @override
  _EmpFollowingTabBodyState createState() => _EmpFollowingTabBodyState();
}

class _EmpFollowingTabBodyState extends State<EmpFollowingTabBody> {
