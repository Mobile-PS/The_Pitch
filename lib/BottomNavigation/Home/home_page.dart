...
import 'package:the_new_pitchapp/BottomNavigation/Home/employer_following_tab.dart';
        ...
        DefaultTabController(
          ...
          child: Stack(
            children: <Widget>[
              TabBarView(
                children: <Widget>[
                  EmployerFollowingTabPage(con.Eployerdata!, false,),
                  FollowingTabPage(con.candidatedata!, true),
                ],
              ),
              SafeArea(
                child: Align(
