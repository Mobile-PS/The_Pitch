...
class BookMarkTabPage extends StatelessWidget {
  ...
  BookMarkTabPage(this.videos, this.images, this.isFollowing, {this.variable});

  @override
  Widget build(BuildContext context) {
    return BookmarkTabBody(videos, images, isFollowing, variable);
  }
}

class BookmarkTabBody extends StatefulWidget {
  final List<String> videos;
  final List<String> images;
  ...
  BookmarkTabBody(this.videos, this.images, this.isFollowing, this.variable);

  @override
  _BookmarkTabBodyState createState() => _BookmarkTabBodyState();
}

class _BookmarkTabBodyState extends State<BookmarkTabBody> {
